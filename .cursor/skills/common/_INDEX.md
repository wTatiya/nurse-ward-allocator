<!-- AUTO-GENERATED from SKILL.md frontmatters — project-maintained rows for meta skills -->
# common Skills Index
...
| **common-skills-audit** | `AGENTS.md`, `.skillsrc`, `.cursor/**` | skills audit, consolidate agents, cursor inventory cleanup, redundant rules |
| **cursor-inventory** | `.cursor/skills/**/SKILL.md`, `.cursor/agents/**` | cursor inventory, list skills, subagent catalog, slash commands |
...
| **vibe-code-auditor** | vibe code, prototype audit, production readiness, AI-generated code, ship readiness |
