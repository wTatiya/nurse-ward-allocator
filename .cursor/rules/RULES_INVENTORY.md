...
Canonical editor rules in `.cursor/rules/**/*.mdc`. Consolidated **2026-07-10**.
...
| Path | Reason |
| --- | --- |
| `.cursor/rules/agent-skill-standard-rule.mdc` | Duplicate of `general/` — **deleted 2026-07-10** (re-delete after `ags sync` if it reappears) |
